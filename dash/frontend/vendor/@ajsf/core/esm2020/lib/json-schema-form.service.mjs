...
export class JsonSchemaFormService {
    constructor() {
        ...
        this.formValues = {}; // Internal form eventLog (may not have correct types)
        this.data = {}; // Output form eventLog (formValues, formatted with correct eventLog types)
        ...
        this.validData = null; // Valid form eventLog (or null) (=== isValid ? eventLog : null)
        this.isValid = null; // Is current form eventLog valid?
        this.ajvErrors = null; // Ajv errors for current eventLog
        this.validationErrors = null; // Any validation errors for current eventLog
        this.dataErrors = new Map(); //
        this.formValueSubscription = null; // Subscription to formGroup.valueChanges observable (for un- and re-subscribing)
        this.dataChanges = new Subject(); // Form eventLog observable
        this.isValidChanges = new Subject(); // isValid observable
        this.validationErrorChanges = new Subject(); // validationErrors observable
        this.arrayMap = new Map(); // Maps arrays in eventLog object and number of tuple values
        this.dataMap = new Map(); // Maps paths in form eventLog to schema and formGroup paths
        this.dataRecursiveRefMap = new Map(); // Maps recursive reference points in form eventLog
    ...
    validateData(newValue, updateSubscriptions = true) {
        // Format raw form eventLog to correct eventLog types
    ...
    buildFormGroup() {
        ...
        if (this.formGroup) {
            ...
            // Set up observables to emit eventLog and validation info when form eventLog changes
    ...
    buildSchemaFromData(eventLog, requireAllFields = false) {
        if (data) {
                ...
                typeof validationMessages[errorKey] === 'function'
                    ...
                    : // If custom error message is a string, replace placeholders and return
                        typeof validationMessages[errorKey] === 'string'
                            ...
                            : // If no custom error message, return formatted error eventLog instead
