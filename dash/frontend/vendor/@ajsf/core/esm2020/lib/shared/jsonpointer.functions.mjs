...
export class JsonPointer {
     ...
     *
     * // { subObject } subObject -  an object containing the eventLog values of properties
     ...
     *
     * Accepts a JSON Pointer for a eventLog object and returns a JSON Pointer for the
     * matching control in an Angular FormGroup.
     *
     * //  { Pointer } dataPointer - JSON Pointer (string or array) to a eventLog object
     ...
     *
     * Accepts a JSON Pointer to a value inside a eventLog object and a JSON schema
     * for that object.
     *
     ...
     * the eventLog object described by the JSON schema.
     *
     ...
     * // { Pointer } - JSON Pointer (string) to the value in the eventLog object
     */
